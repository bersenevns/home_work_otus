...
Все необходимые loopback известны и доступны по сети. Сессии evpn также установлены, VTEPs видны. Мы видим маршруты type-3 (IMET) и type-5 (ip-prefix). Маршруты type-2 (mac-ip) пока неизвестны, потому что еще не было трафика от хостов. 
